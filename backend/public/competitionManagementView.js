 ...
 * Main container for Competition and Results Management (NOT financial accounts)
 * Handles: Competition CRUD, Results Management, Season Management, CSV Results Import/Export
 */

export class CompetitionManagementView {
  ...
  async initialize() {
    try {
      ...
      this.competitionList = new CompetitionList(this.apiClient, 'management');
      ...
      console.log('CompetitionManagementView initialized successfully');
    } catch (error) {
      console.error('Error initializing CompetitionManagementView:', error);
      throw error;
    }
  }
  ...
  renderCompetitionSection(container) {
    ...
    // Add weekly transactions container for inline drill-down
    const weeklyTransactionsContainer = document.createElement('div');
    weeklyTransactionsContainer.className = 'weekly-transactions-container';
    weeklyTransactionsContainer.id = 'weekly-transactions-container';
    weeklyTransactionsContainer.style.display = 'none'; // Hidden by default
    this.competitionSection.appendChild(weeklyTransactionsContainer);
  ...
  handleCompetitionSelected(competition) {
    console.log('CompetitionManagementView: Competition selected event received:', competition);
  ...
  async refresh() {
    try {
      ...
      console.error('Error refreshing CompetitionManagementView:', error);
    }
  }
